...
template <typename T> class colorful : private std::list<item<T>> {
public:
  ...
  template <typename U> friend colorful<U> invert(colorful<U> col);
};

template <typename T> colorful<T> operator+(colorful<T> lhs, colorful<T> rhs) {
  colorful<T> res(std::move(lhs));
  return res += rhs;
}

template <typename T> colorful<T> operator+(colorful<T> lhs, std::string rhs) {
  colorful<T> res(std::move(lhs));
...
template <typename T> colorful<T> invert(colorful<T> col) {
